...
import raven.application.form.other.Supplier_Details;
...
public class Suppliers_List extends javax.swing.JPanel {
    ...
    public Suppliers_List() {
      ...
      Object[][] supplierSampleData = {
        ...
        // Column names
        String[] columnNames = {
            "#", "Image", "Supplier ID", "Name", "Contact Number", "Email", "Company Name", "Status", "Action"
        };

        // Create a DefaultTableModel and set it to the table
        DefaultTableModel model = new DefaultTableModel(supplierSampleData, columnNames);
...
public void onView(int row) {
          Application.showForm(new Supplier_Details());
